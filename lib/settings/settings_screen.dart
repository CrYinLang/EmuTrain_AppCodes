        ...
        _buildSection(
          ...
          children: [
            _buildTile(
              ...
              trailingIcon: Icons.arrow_forward_ios,
              onTap: () => Navigator.of(context).push(
                MaterialPageRoute(builder: (_) => const DataVersionScreen()),
              ),
            ),
            const Divider(height: 1),
            Container(
                ...
                children: [
                  ...
                  DropdownButton<String>(
                        ...
                        .map(
                          (v) => DropdownMenuItem(
                            ...
                            child: Text(
                              ...
                              style: TextStyle(
                                fontSize: 16,
                                color: kIsWeb ? Theme.of(context).hintColor : null,
                              ),
                            ),
                          ),
                        )
                    ...
                    onChanged: kIsWeb ? null : (v) async {
                      if (v != null) {
                        setState(() => _mirrorSource = v);
                        await _saveSetting(_mirrorSourceKey, v);
                        await Vars.setMirrorSource(v);
                      }
                    },
                  ),
                ],
            ...
            Tool.buildSwitch(
              context: context,
              title: '自动检测更新',
              subtitle: kIsWeb ? '网页版不可用' : '在有更新时自动弹出',
              icon: Icons.browser_updated_sharp,
              value: kIsWeb ? false : _showAutoUpdate,
              onChanged: kIsWeb ? null : (v) async {
      ...
      children: [
        ...
        _buildSection(
          ...
          children: [
            ...
            if (!kIsWeb) _buildDataSourceRow<TrainStationDataSource>(
        ...
        if (!kIsWeb) _buildSection(
          ...
          children: [
            ...
            if (!kIsWeb) _buildDataSourceRow<TrainEmuDataSource>(
        ...
        Tool.buildSection(
          ...
          children: [
            Tool.buildSwitch(
              context: context,
              title: '显示列车图片',
              subtitle: kIsWeb ? '网页版不可用' : '在旅途详情中显示列车图片',
              icon: Icons.photo_camera,
              value: kIsWeb ? false : _showTrainImage,
              onChanged: kIsWeb ? null : (v) async {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SwitchListTile(
                      ...
                      secondary: Icon(Icons.phone_android, color: cs.primary),
                      value: followSystem,
