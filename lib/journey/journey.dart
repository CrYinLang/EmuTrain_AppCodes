...
class _AddJourneyPageState extends State<AddJourneyPage>
  ...
  Future<void> _searchTrain() async {
    ...
    try {
      ...
      logError(from: 'journey/unknown', error: e.toString());
      _showSnack('发生错误: $e');
    } finally {
  ...
  Future<String> _getBenWu(String trainCode, String date) async {
    ...
    } catch (e) { logError(from: 'journey/_getBenWu', error: e.toString()); }
    return '未知';
  }
  ...
  String _formatPrice(dynamic priceValue, dynamic priceValueBa) {
    ...
    try {
      ...
      logError(from: 'journey/_formatPrice', error: e.toString());
      return '--';
    }
  }
  ...
  void _handleSelect(
    ...
    if (isStation) {
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                _addJourney(index, train, true, actualTravelDate: pickedDate);
              },
              child: const Text('添加'),
            ),
          ],
      ...
      _showStationRangeSelector(index, train, actualTravelDate: pickedDate);
    }
  }
  ...
  void _addJourney(
    ...
    DateTime actualDate = actualTravelDate ?? _selectedDate!;
